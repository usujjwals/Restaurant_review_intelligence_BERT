...
This comparison helped us measure how traditional lexicon-based sentiment differs from deep learning-based sentiment. The transformer model captured more mixed and complaint-heavy reviews, making it more useful for business interpretation. :contentReference[oaicite:5]{index=5}

## Key Outcomes
- Most reviews were positive overall, but **BERT detected more negative sentiment than VADER**, showing that it was better at identifying nuanced dissatisfaction. :contentReference[oaicite:6]{index=6}
- The two models **disagreed on 1,619 reviews**, which showed the value of comparing lexicon-based and transformer-based methods. :contentReference[oaicite:7]{index=7}
- The biggest recurring complaint themes were **customer service, wait times, and consistency**. :contentReference[oaicite:8]{index=8}
- The most important food-related terms in customer language were **fried chicken** and **mac & cheese**, making them key drivers of restaurant perception. :contentReference[oaicite:9]{index=9}
- Topic modeling showed that the market conversation centers around **Southern comfort food, soul food sides, hot chicken, and service quality**. :contentReference[oaicite:10]{index=10}
- Time series analysis suggested that the market grew sharply after 2020 and is now beginning to stabilize, indicating a maturing but still competitive space. :contentReference[oaicite:11]{index=11}
...
- `finaldataset.csv` / `finaldataset (1).csv` — cleaned final dataset used for analysis :contentReference[oaicite:12]{index=12} :contentReference[oaicite:13]{index=13}
